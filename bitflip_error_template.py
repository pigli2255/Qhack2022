...
def error_wire(circuit_output):
    ...
    ans[0] = circuit_output[0] + circuit_output[-1]
    ans[1] = circuit_output[3] + circuit_output[4]
    ans[2] = circuit_output[2] + circuit_output[5]
    ans[3] = circuit_output[1] + circuit_output[6]
